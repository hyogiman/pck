...
const BETWEEN_V2_SYNTHETIC_CASES = Object.freeze([
  ...
  },
  {
    ...
    a: "요즘 일이 끝나면 아무것도 하지 않아야 회복될 것 같다는 생각이 자주 든다. 주말에도 일부러 아무 계획을 잡지 않으려 한다.",
    b: "무언가를 내 손으로 만들고 있을 때는 시간이 빨리 가고, 오히려 내가 내 삶을 살고 있다는 느낌이 든다.",
    why: "A의 무활동을 통한 회복 욕구와 B의 만들 때 느끼는 생동감이 함께 있어야, 회복과 생동감이 서로 다른 필요인지 또는 함께 충족될 수 있는지를 새로 탐색할 수 있다."
  },
  {
