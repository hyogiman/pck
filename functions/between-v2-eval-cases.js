...
const BETWEEN_V2_SYNTHETIC_CASES = Object.freeze([
  ...
  },
  {
    ...
    group: "speak",
    label: "몸의 회복과 창작의 생동감",
    expectedDecision: "speak",
    a: "이번 토요일은 약속을 하나도 잡지 않고 집에서 쉬었다. 저녁이 되니 몸의 피로가 많이 풀린 느낌이었다.",
    b: "다음 토요일에는 오후 내내 작은 나무 선반을 만들었다. 몸은 조금 피곤했지만 오랜만에 내가 내 삶을 산 것 같은 만족감이 남았다.",
    why: "같은 주말 여가 맥락에서 A는 몸의 회복을, B는 창작 뒤의 생동감과 만족을 보여준다. 둘을 함께 봐야 주말의 회복을 몸의 피로와 삶의 감각이라는 두 차원으로 새로 탐색할 수 있다."
  },
  {
  ...
  },
  {
    ...
    b: "지난 여행에서 저녁을 먹고 숙소로 돌아가는 길에 목적 없이 골목을 걷다가 작은 시장을 발견했다. 그 시간이 여행에서 가장 좋았다.",
    why: "A의 촘촘한 계획 욕구와 B의 목적 없이 걷다 얻은 만족이 함께 있어야, 여행에서 통제와 여지를 어떻게 경험하는지라는 새 긴장을 탐색할 수 있다."
  },
  {
