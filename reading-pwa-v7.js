/* 독서의 정원 v30 — 독립 PWA 설치 보조 + 안정성/모달 런타임 로드 */
let deferredInstallPrompt=null;
const READING_INSTALL_MARK='readingGarden_pwa_installed_v1';
const RG_SW_VERSION='20260906-reading-v30';
...
import('./reading-dialogs-v18.js?v=20260906-reading-v30').catch(err=>console.warn('Reading Garden dialog runtime failed',err));
import('./reading-stability-v16.js?v=20260906-reading-v30').catch(err=>console.warn('Reading Garden stability runtime failed',err));
