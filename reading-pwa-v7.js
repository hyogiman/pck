/* 독서의 정원 v19 — 독립 PWA 설치 보조 + 안정성/모달 런타임 로드 */
let deferredInstallPrompt=null;
const READING_INSTALL_MARK='readingGarden_pwa_installed_v1';
const RG_SW_VERSION='20260904-reading-v19';
...
/* 필기 성능 최적화는 reading.js 원본에 통합했다.
   v19는 브라우저 기본 confirm/alert를 앱 모달로 통일하고,
   필사 미리보기의 base64 복제를 막으며,
   OCR 결과가 없어도 필사 이미지만 확정할 수 있게 한다. */
import('./reading-dialogs-v18.js?v=20260904-reading-v19').catch(err=>console.warn('Reading Garden dialog runtime failed',err));
import('./reading-stability-v16.js?v=20260904-reading-v19').catch(err=>console.warn('Reading Garden stability runtime failed',err));
